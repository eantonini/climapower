...
def get_wind_capacity_factor_time_series(country_info, region_shape, year, offshore, alpha=1.0, beta=0.0):
    ...
    if settings.read_wind_coefficients and not offshore: 
        coefficients = calibration_utilities.read_calibration_coefficients(country_info, 'wind', offshore=offshore, additional_info=('__offshore' if offshore else '__onshore'))
