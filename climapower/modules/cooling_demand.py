...
def get_cooling_demand_time_series(region_shape, year, threshold, hour_shift=0.0, hourly_series=False):
    ...
    time_series = atlite.convert.convert_heat_demand(temperature_database, threshold=threshold, a=1.0, constant=0.0, hour_shift=hour_shift, cooling=True, hourly_series=hourly_series) # type: ignore
