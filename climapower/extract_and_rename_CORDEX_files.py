...
for CORDEX_variable_name in CORDEX_variable_names:
    ...
    for year in range(start_year,end_year+1):
        ...
        original_data_file = directories.get_climate_data_path(year, CORDEX_variable_name, time_resolution=CORDEX_time_resolution, climate_data_source='projections').replace('.nc', '.tar.gz')

        # Define new data path.
        new_data_file = directories.get_climate_data_path(year, CORDEX_variable_name, time_resolution=CORDEX_time_resolution, climate_data_source='projections').replace('.nc', '__original.nc')
        ...
        extracted_filename = directories.get_climate_data_path(year, CORDEX_variable_name, time_resolution=CORDEX_time_resolution, climate_data_source='projections', return_folder=True) + extracted_filename
